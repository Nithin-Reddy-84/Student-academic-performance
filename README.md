...
After running, you will see a link like:
...
- Probability output for prediction
...
- Run the app using terminal (not Jupyter Notebook).
...
Student Academic Performance ML Project
